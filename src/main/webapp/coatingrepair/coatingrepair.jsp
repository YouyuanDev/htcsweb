        ...
        function delCoatingRepair() {
            ...
            if(row.length>0){
                ...
                $.messager.confirm('系统提示',"您确定要删除这<font color=red>"+idArr.length+ "</font>条数据吗？",function (r) {
                    if(r){
                        $.post(
                            "/coatingRepairOperation/delCoatingRepairO.action",
                ...
                //hlAlertFive("/coatingRepairOperation/delContract.action",idArrs,idArr.length);
            ...
            $('#coatingRepairForm').form('submit',{
                ...
                success: function(result){
                    ...
                    if (result.success){
                        ...
                        // $('#repairDatagrids').datagrid('clearSelections');
                    } else {
        ...
        <fieldset style="width:900px;border:solid 1px #aaa;margin-top:8px;position:relative;">
            ...
            <table class="ht-table">
                <tr>
                    ...
                    <td colspan="3" width="30%"><label id="crid"></label></td>
            ...
            <table class="ht-table">
                <tr>
                    <td class="i18n1" name="coatingtype">涂层类型</td>
                    <td colspan="2">
                        <select id="coating_type" class="easyui-combobox" data-options="editable:false" name="coating_type"   style="width:200px;">
                            <option value="2FBE">2FBE</option>
                            <option value="3LPE">3LPE</option>
                            <option value="Other">Other</option>
                        </select>
                    </td>
                    <td class="i18n1" name="odid">外/内防</td>
                    <td colspan="2"><select id="odid" class="easyui-combobox" data-options="editable:false" name="odid"   style="width:200px;">
                ...
                <tr>
                    <td class="i18n1" name="repairsize">修补大小</td>
                    <td colspan="2">
                        <input class="easyui-textbox"  type="text" name="repair_size" value=""/>

                    </td>
                    <td class="i18n1" name="repairnumber">修补数量</td>
                    <td colspan="2">
                        <input class="easyui-numberbox" data-options="min:0,precision:0" type="text" name="repair_number" value=""/>
                    </td>
                </tr>
                <tr>
                    <td class="i18n1" name="holidaynumber">漏点数量</td>
                    <td colspan="2">
                        <input class="easyui-numberbox" data-options="min:0,precision:0" type="text" name="holiday_number" value=""/>

                    </td>
                    <td class="i18n1" name="repairmethod">修补方法</td>
                    <td colspan="2">
                        <select id="repair_method" class="easyui-combobox" data-options="editable:false" name="repair_method"   style="width:200px;">
                ...
                <tr>
                    <td class="i18n1" name="unqualifiedreason">不合格原因</td>
                    <td colspan="2">
                        <input class="easyui-textbox"  type="text" name="unqualified_reason" value=""/>

                    </td>
                    <td class="i18n1" name="inspectorno">检验员编号</td>
                    <td colspan="2">
                ...
                <tr>
                    <td class="i18n1" name="inspectiontime">检验时间</td>
                    <td colspan="2">
                    ...
                    <td class="i18n1" name="surfacecondition">表面质量</td>
                    <td colspan="2">
                        <select id="surface_condition" class="easyui-combobox" data-options="editable:false" name="surface_condition"   style="width:200px;">
                ...
                <tr>
                    <td class="i18n1" name="repairthickness">修补厚度</td>
                    <td colspan="2">
                        <input class="easyui-textbox"  type="text" data-options="multiline:true" name="repair_thickness" value=""/>

                    </td>
                    <td class="i18n1" name="holidaytesting">漏点检测</td>
                    <td colspan="2">
                        <select id="holiday_testing" class="easyui-combobox" data-options="editable:false" name="holiday_testing"   style="width:200px;">
                            <option value="OK">OK</option>
                            <option value="Not OK">Not OK</option>
                        </select>
                    </td>
                ...
                <tr>
                    <td class="i18n1" name="adhesion">附着力</td>
                    <td colspan="2">
