    ...
    <script type="text/javascript">
        $(function() {
            ...
            $('.btnReport').click(function () {
                ...
                var options={
                    type:'POST',
                    url:'/StatisticsOperation/getStatisticsExcel.action',
                    dataType:'json',
        ...
        function getCheckProgress(){
            var progressUrl = '/StatisticsOperation/getStatisticExcelProgress.action';
            ...
            $.ajax({
                ...
                success:function(data){
                    if(data.statisticExcelProgress>=100){
                    ...
                    $('#p').progressbar('setValue',data.statisticExcelProgress);
                },
                //请求出错的处理
                error:function(){
                    window.clearInterval(timerId);
