...
<fieldset class="b3" style="padding:10px;margin:10px;">
    ...
    <div  style="margin-top:5px;">
        <table class="easyui-datagrid" id="PipeRebevelProDatagrids" url="/PipeRebevelOperation/getAllPipeRebevelByLike.action" striped="true" loadMsg="正在加载中。。。" textField="text" pageSize="20" fitColumns="true" pagination="true" toolbar="#hlPipeRebevelProTb">
            <thead>
            <tr>
...
>
    ...
    <div id="datagrid1" class="mini-datagrid" style="width:100%;height:100%;"
         ...
         url="/pipeinfo/getNeedRebevelPipeNumbers.action">
