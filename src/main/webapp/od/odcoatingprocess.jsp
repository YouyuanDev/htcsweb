        ...
        function editOdCoatingPro() {
            ...
            if(row){
                ...
                $('#odCoatingProForm').form('load', {
                    ...
                    'top_coat_gun_count': row.top_coat_gun_count,
        ...
        function odCoatingProFormSubmit() {
            $('#odCoatingProForm').form('submit',{
                ...
                onSubmit:function () {
                    ...
                    if($("input[name='operatioin_time']").val()==""){
                        hlAlertFour("请输入操作时间");
                        return false;
                    }
        ...
        <fieldset style="width:900px;border:solid 1px #aaa;margin-top:8px;position:relative;">
            ...
            <table class="ht-table">
                ...
                <tr>
                    ...
                    <td><input class="easyui-numberbox" data-options="min:-99,precision:0" type="text" name="base_coat_gun_count" value=""/></td>
                    <td></td>
                    <td width="16%" class="i18n1" name="topcoatguncount">面层粉末喷枪数</td>
                    <td><input class="easyui-numberbox" data-options="min:-99,precision:0" type="text" name="top_coat_gun_count" value=""/></td>
                    <td></td>
