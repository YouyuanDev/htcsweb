...
<fieldset class="b3" style="padding:10px;margin:10px;">
    ...
    <div  style="margin-top:5px;">
        <table class="easyui-datagrid" id="odCoatProDatagrids" url="/OdOperation/getNewOdBlastByLike.action" striped="true" loadMsg="正在加载中。。。" textField="text" pageSize="20" fitColumns="true" pagination="true" toolbar="#hlOdBlastProTb">
            <thead>
            <tr>
                ...
                <th field="coating_line_speed" align="center" width="120" class="i18n1" name="coatinglinespeed">涂敷线速度</th>
                <th field="base_coat_used" align="center" width="120" class="i18n1" name="basecoatused">底层粉末型号</th>
                ...
                <th field="application_temp" align="center" width="120" class="i18n1" name="applicationtemp">中频温度</th>
