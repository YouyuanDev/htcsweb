...
<fieldset class="b3" style="padding:10px;margin:10px;">
    ...
    <div  style="margin-top:5px;">
        <table class="easyui-datagrid" id="PipeSamplingProDatagrids" url="/PipeSamplingOperation/getAllPipeSamplingByLike.action" striped="true" loadMsg="正在加载中。。。" textField="text" pageSize="20" fitColumns="true" pagination="true" toolbar="#hlPipeSamplingProTb">
            <thead>
            <tr>
