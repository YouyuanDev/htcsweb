...
<!--添加、修改框-->
<div id="hlRawMaterialtestEpoxyDialog" class="easyui-dialog" data-options="title:'添加',modal:true"  closed="true" buttons="#dlg-buttons" style="display: none;padding:5px;width:950px;max-height:600px;overflow-y: scroll;">
