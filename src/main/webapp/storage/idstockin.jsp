...
<head>
    ...
    <script type="text/javascript">
        ...
        function IDPipeStockInCancelSubmit(){
...
<div id="hlIdStockinDialog" class="easyui-dialog" data-options="title:'添加',modal:true"  closed="true" buttons="#dlg-buttons" style="display: none;padding:5px;width:950px;height:auto;">
    <form id="idStockinForm" method="post">
...
<div id="dlg-buttons" align="center" style="width:900px;">
    <a href="#" class="easyui-linkbutton" iconCls="icon-save" onclick="IDPipeStockIn()">Submit</a>
    <a href="#" class="easyui-linkbutton" id="hlcancelBtn" operationtype="add" iconCls="icon-cancel" onclick="IDPipeStockInCancelSubmit()">Cancel</a>
</div>
