...
public class RawMaterialTestingAcceptanceCriteria3Lpe {
    ...
    private float  epoxy_particle_size_max;
    private float  epoxy_particle_size_min;
    ...
    public RawMaterialTestingAcceptanceCriteria3Lpe(int id, String raw_material_testing_acceptance_criteria_no, float epoxy_cure_time_max, float epoxy_cure_time_min, float epoxy_gel_time_max, float epoxy_gel_time_min, float epoxy_moisture_content_max, float epoxy_moisture_content_min, float epoxy_particle_size_max, float epoxy_particle_size_min, float adhesion_flow_rate_max, float adhesion_flow_rate_min, float polyethylene_flow_rate_max, float polyethylene_flow_rate_min, Date last_update_time) {
        ...
        this.epoxy_particle_size_max = epoxy_particle_size_max;
        this.epoxy_particle_size_min = epoxy_particle_size_min;
    ...
    public float getEpoxy_particle_size_max() {
        return epoxy_particle_size_max;
    }

    public void setEpoxy_particle_size_max(float epoxy_particle_size_max) {
        this.epoxy_particle_size_max = epoxy_particle_size_max;
    }

    public float getEpoxy_particle_size_min() {
        return epoxy_particle_size_min;
    }

    public void setEpoxy_particle_size_min(float epoxy_particle_size_min) {
        this.epoxy_particle_size_min = epoxy_particle_size_min;
    }
