...
public interface IdFinalInspectionProcessDao {
    ...
    //获取内涂终检记录PDF
    public List<HashMap<String,Object>>getIdCoatFinalInspectionRecord(@Param("project_no")String project_no,@Param("begin_time")Date begin_time, @Param("end_time")Date end_time);
}
