...
public interface IdFinalInspectionProcessDao {
    ...
    //获取内涂终检记录PDF
    public List<HashMap<String,Object>>getIdCoatFinalInspectionRecord(@Param("project_no")String project_no,@Param("mill_no")String mill_no,@Param("od")float od,@Param("wt")float wt,@Param("begin_time")Date begin_time, @Param("end_time")Date end_time);
    //获取当天内防腐合格总数和合格长度
