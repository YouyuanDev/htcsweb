...
public interface OdFinalInspectionProcessDao {
    ...
    //获取当天外防腐合格总数
    public int getTotalQualifiedOfDay(@Param("project_no")String project_no,@Param("external_coating")String external_coating,@Param("od")float od,@Param("wt")float wt,@Param("begin_time")Date begin_time, @Param("end_time")Date end_time,@Param("result")String result);
}
