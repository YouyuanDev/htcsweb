...
public interface OdFinalInspectionProcessDao {
    ...
    //获取外涂终检记录
    public List<HashMap<String,Object>>getOdFianlInspectionRecord(@Param("project_no")String project_no,@Param("mill_no")String mill_no,@Param("external_coating")String external_coating,@Param("begin_time")Date begin_time, @Param("end_time")Date end_time);
    //获取当天外防腐合格总数与合格长度
