...
public interface OdCoating3LpeInspectionProcessDao {
    ...
    //获取3lpe外涂检验记录
    public List<HashMap<String,Object>>getOd3LPECoatInspectionRecord(@Param("project_no")String project_no,@Param("mill_no")String mill_no,@Param("od")float od,@Param("wt")float wt,@Param("begin_time")Date begin_time, @Param("end_time")Date end_time);
    //获取当天3lpe外防待扒皮数量
    ...
    //根据钢管编号查询最新一条记录
    public OdCoating3LpeInspectionProcess getRecentRecordByPipeNo(@Param("pipe_no")String pipe_no);
}
