...
@Controller
@RequestMapping("/OdCoat3LpeOperation")
public class OdCoating3LpeProcessController {
    @Autowired
    ...
    public String getOdCoating3LpeByLike(@RequestParam(value = "pipe_no",required = false)String pipe_no, @RequestParam(value = "operator_no",required = false)String operator_no, @RequestParam(value = "begin_time",required = false)String begin_time, @RequestParam(value = "end_time",required = false)String end_time, @RequestParam(value = "mill_no",required = false)String mill_no, HttpServletRequest request){
        ...
        List<HashMap<String,Object>> list=odCoating3LpeProcessDao.getAllByLike(pipe_no,operator_no,beginTime,endTime,mill_no, start,Integer.parseInt(rows));
        int count=odCoating3LpeProcessDao.getCountAllByLike(pipe_no,operator_no,beginTime,endTime,mill_no);
    ...
    //添加、修改
    @RequestMapping("/saveOdCoating3LpeProcess")
    @ResponseBody
    ...
    //删除
    @RequestMapping("/delOdCoating3LpeProcess")
    public String delOdCoatingProcess(@RequestParam(value = "hlparam")String hlparam,HttpServletResponse response)throws Exception{
        ...
        int resTotal=0;
        resTotal=odCoating3LpeProcessDao.delOdCoating3LpeProcess(idArr);
        JSONObject json=new JSONObject();
    ...
    //得到可以钢管最新的待定的3lpe涂层记录  最后一条记录且result为待定 10
    ...
    public String getPendingRecordByPipeNo(@RequestParam(value = "pipe_no",required = false)String pipe_no, HttpServletRequest request) {
        ...
        OdCoating3LpeProcess record=odCoating3LpeProcessDao.getRecentRecordByPipeNo(pipe_no);
        Map<String,Object> maps=new HashMap<String,Object>();
    ...
    public String getLastAcceptedRecordBeforePipeNo(@RequestParam(value = "pipe_no",required = false)String pipe_no, HttpServletRequest request) {
        ...
        Map<String,Object> maps=new HashMap<String,Object>();
        if(mill_no!=null){
            OdCoating3LpeProcess record=odCoating3LpeProcessDao.getLastAcceptedRecordBeforePipeNo(pipe_no,mill_no);
            if(record!=null){
                //是合格状态
                maps.put("success",true);
                maps.put("record",record);
