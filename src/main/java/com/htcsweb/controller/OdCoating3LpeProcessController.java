...
public class OdCoating3LpeProcessController {
    ...
    public String getOdCoating3LpeByLike(@RequestParam(value = "pipe_no",required = false)String pipe_no, @RequestParam(value = "operator_no",required = false)String operator_no, @RequestParam(value = "begin_time",required = false)String begin_time, @RequestParam(value = "end_time",required = false)String end_time, HttpServletRequest request){
        ...
        List<HashMap<String,Object>> list=odCoating3LpeProcessDao.getAllByLike(pipe_no,operator_no,beginTime,endTime,start,Integer.parseInt(rows));
        int count=odCoating3LpeProcessDao.getCountAllByLike(pipe_no,operator_no,beginTime,endTime);
