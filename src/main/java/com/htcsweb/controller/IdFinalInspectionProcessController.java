...
public class IdFinalInspectionProcessController {
    ...
    public String getIdFinalInByLike(@RequestParam(value = "pipe_no",required = false)String pipe_no, @RequestParam(value = "operator_no",required = false)String operator_no, @RequestParam(value = "begin_time",required = false)String begin_time, @RequestParam(value = "end_time",required = false)String end_time, HttpServletRequest request){
        ...
        List<HashMap<String,Object>> list=idFinalInspectionProcessDao.getAllByLike(pipe_no,operator_no,beginTime,endTime,start,Integer.parseInt(rows));
        int count=idFinalInspectionProcessDao.getCountAllByLike(pipe_no,operator_no,beginTime,endTime);
