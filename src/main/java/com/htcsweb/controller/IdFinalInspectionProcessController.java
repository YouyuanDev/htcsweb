...
public class IdFinalInspectionProcessController {
    ...
    //得到可以钢管最新的待定的内防终检记录  最后一条记录且result为待定 10
    ...
    public String getPendingRecordByPipeNo(@RequestParam(value = "pipe_no",required = false)String pipe_no, HttpServletRequest request) {
        ...
        IdFinalInspectionProcess record=idFinalInspectionProcessDao.getRecentRecordByPipeNo(pipe_no);
        Map<String,Object> maps=new HashMap<String,Object>();
